#!/bin/bash
# -*- coding: utf-8 -*-
# Timestamp: "2025-12-25 16:18:56 (ywatanabe)"
# File: ./.claude/to_claude/hooks/pre-tool-use/check_line_number_limit.sh
...
# Skip test files (tests/ or test_*.py files)
case "$FILE_PATH" in
...
if [ "$PROPOSED" -gt "$THRESHOLD" ]; then
    {
        ...
        echo "  2.  Refactor (split modules, keep orchestrator thin)"
